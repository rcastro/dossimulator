...
public interface IProblem extends Configurable {
	...
	/**
	 * Returns the lower limit of the search space for this problem in the given
	 * dimension.
	 * 
	 * @param dimension The dimension for which we want to know the lower limit.
	 * @return The lower limit of the search space for this problem in the given
	 *         dimension.
	 */
	double getLowerLimit(int dimension);

	/**
	 * Returns the upper limit of the search space for this problem in the given
	 * dimension.
	 * 
	 * @param dimension The dimension for which we want to know the upper limit.
	 * @return The upper limit of the search space for this problem in the given
	 *         dimension.
	 */
