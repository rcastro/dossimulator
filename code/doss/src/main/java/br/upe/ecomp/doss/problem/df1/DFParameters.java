...
public class DFParameters {
	...
	public DFParameters(double ah, double ar, double ax, int dimensions,
			boolean dynamicH, boolean dynamicR, boolean dynamicX, int hBase,
			int hRange, double hScale, int rBase, int rRange, double rScale,
			int xBase, int xRange, double xScale) {
		this.aH = ah;
		this.aR = ar;
		this.aX = ax;
