...
import br.upe.ecomp.doss.algorithm.apso.APSOParticle;
import br.upe.ecomp.doss.algorithm.pso.PSOParticle;
import br.upe.ecomp.doss.problem.Problem;

/**
 * An specialization of the {@link PSOParticle} class for the VolitiveAPSO algorithm.
 * 
 * @author George Moraes
 */
public class WeightedAPSOParticle extends APSOParticle {
     ...
     */
    public WeightedAPSOParticle(int dimensions) {
        super(dimensions);
        deltaFitness = 0;
